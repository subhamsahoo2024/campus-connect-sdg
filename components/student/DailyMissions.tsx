          ...
          return (
            <li
              ...
              className={`flex items-start gap-3 rounded-lg p-3 transition-all ${
                done ? 'bg-green-500/5 ring-1 ring-green-500/20' : 'bg-white/3 ring-1 ring-white/5'
              }`}
            >
              <button
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="mt-0.5 text-xs text-slate-400 leading-relaxed">{mission.description}</p>
              </div>
